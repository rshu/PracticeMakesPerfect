...
class Solution {
    ...
    private int findMaxDepth(List<NestedInteger> nestedList) {
        ...
        for (NestedInteger n : nestedList) {
            if (!n.isInteger()) {
                depth = Math.max(depth, 1 + findMaxDepth(n.getList()));
            }
        }
    ...
    private int helper(List<NestedInteger> nestedList, int depth, int maxDepth) {
        int sum = 0;
        ...
        for (NestedInteger n : nestedList) {
            if (n.isInteger()) {
                ...
                sum += helper(n.getList(), depth + 1, maxDepth);
            }
        }
